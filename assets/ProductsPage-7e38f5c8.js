import{e as M,r as h,q as fr,R as $t,t as pr,a as xt,f as he,v as hr,j as x,w as Bt,x as be,Q as mr,y as gr,p as vr,L as br,z as xr,A as Er,C as Cr}from"./index-4a5c7b77.js";import{S as yr}from"./Section-492816ac.js";import{T as Sr}from"./Text.styled-218166ae.js";import{s as $e}from"./sprite-170aadc4.js";import{F as wr}from"./Form-c64b5c7d.js";import"./Fieldset.styled-66d78bf9.js";/* empty css                         */import{_ as Ce,a as bn,b as Fr,c as Or,d as Ar,e as Dr,f as Ir,g as Mr}from"./defineProperty-8501a314.js";import{c as Pr}from"./selectors-6efb1357.js";import{B as jt,E as Vr}from"./ExerciseIcon-5b577969.js";import{T as Ht}from"./Text-4948b2af.js";import{C as Rr}from"./Loader-34e6a5e3.js";import"./InputValidation-704be027.js";const Lr="/leader-code-team-power-pulse/assets/products-1x-60ae029e.jpg",kr="/leader-code-team-power-pulse/assets/products-2x-88f016c5.jpg",zt="/leader-code-team-power-pulse/assets/products-tablet-2x-d8bdd0d5.jpg",Nt="/leader-code-team-power-pulse/assets/products-mobil-2x-b29d44f2.jpg",Tr=M.div`
  display: flex;
...
`,Ks=({id:t,productName:e,calories:r,onClick:i,onClickSuccess:n,transferCaloriesAmount:o})=>{const s=xt(),[l,a]=h.useState(""),u=Math.round(l*r/100),c={position:"top-center",autoClose:2e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"dark"},d=he(Pr),g={productId:t,amount:l,date:d},v=f=>{if(f.preventDefault(),u<=0){a(""),mr.error("Weight must be greater than 0",c);return}s(gr(g)).unwrap().then(()=>s(vr)).catch(p=>console.log(p)),i(),n(),o(u)},b=()=>{i()};return x.jsx(Ts,{children:x.jsxs($s,{children:[x.jsx(Bs,{children:x.jsx(js,{type:"text",value:e,name:"productName",disabled:!0})}),x.jsxs(Hs,{children:[x.jsx(zs,{type:"number",value:l,name:"productQuantity",onChange:f=>a(f.target.value),placeholder:"0"}),x.jsx(Ns,{children:"grams"})]}),x.jsxs(_s,{children:[x.jsx(Us,{children:"Calories:"}),x.jsx(Ws,{children:u})]}),x.jsxs(Gs,{children:[x.jsx(Ys,{type:"submit",onClick:v,children:"Add to diary"}),x.jsx(qs,{type:"button",onClick:b,children:"Cancel"})]})]})})},Xs="/leader-code-team-power-pulse/assets/avocado-832d00b1.png",Qs=M.div`
  padding: 48px 75px;
  display: flex;
  flex-direction: column;
  align-items: center;
...
`,Tu=()=>x.jsxs(yr,{backgrounds:{desctop:Lr,desctopretina:kr,tablet:zt,tabletretina:zt,mobil:Nt,mobilretina:Nt},children:[x.jsx(yu,{children:x.jsx(Sr,{tag:"h1",size:"h3",children:"Products"})}),x.jsx(ks,{}),x.jsx(Cu,{})]});export{Tu as default};
