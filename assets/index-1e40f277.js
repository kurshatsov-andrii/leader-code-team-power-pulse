import{e as o,H as W,r as h,j as t,a as q,Q as I,J as P,L as Z,f as A,F as O,K as G}from"./index-44d4326e.js";import{d as L}from"./device-385ab3fc.js";import{A as B,B as E,E as J}from"./BasicModalWindow-cbc80bb0.js";import{b as N,a as $}from"./selectors-b58aa764.js";import{f as Q}from"./format-4e6081aa.js";import{B as _}from"./Button-989ea224.js";import"./sprite-7d58a2e8.js";const ee=o.ul`
  display: flex;
  flex-wrap: wrap;
  gap: 20px;
  margin-left: 20px;
...
`,Ue=o.span`
  ...
  font-weight: 700;
  line-height: 18px;
`,Ve={0:()=>"",1:e=>`${e} minute `,2:e=>`${e} minutes `,3:e=>`${e} minutes `},Xe=e=>{const r=Math.floor(e/60),n=Math.floor(e-r*60);return`${Ve[r](r)}${n===0?"":`${n} seconds`}`},Ae={position:"top-center",autoClose:2e3,hideProgressBar:!1,closeOnClick:!0,pauseOnHover:!0,draggable:!0,progress:void 0,theme:"dark"},Ee=({exerciseTask:e,onClick:r,onComplete:n,setResult:i})=>{const s=q(),[a,l]=h.useState(!0),[d,m]=h.useState({exerciseId:e._id,time:0,calories:0}),f=()=>{l(u=>!u)},g=u=>{if(u.preventDefault(),d.time<20){I.error("Minimum 20 sec.",Ae);return}const k=Q(new Date,"dd-MM-yyyy"),w={...d,date:k};i({time:Xe(d.time),calories:d.calories}),delete w.calories,s(P(w)),m({exerciseId:null,time:0,calories:0}),r(),n()},{name:c,bodyPart:p,equipment:b,gifUrl:v,target:S,burnedCalories:C,time:j}=e,x=j*60,y=u=>{const k=x-u,w=Math.round(k*C/x);m(R=>({...R,time:k,calories:w}))},z=[{title:"Name",value:c},{title:"Target",value:S},{title:"Body Part",value:p},{title:"Equipment",value:b}];return t.jsxs(H,{children:[t.jsxs(we,{children:[t.jsx(ye,{$gifUrl:v,src:v,alt:`Exercise ${c}`}),t.jsx(ke,{children:"time"}),t.jsx(Y,{strokeWidth:4,duration:x,isPlaying:!a,size:124,colors:"#E6533C",onComplete:()=>f(),onUpdate:u=>y(u),children:({remainingTime:u})=>{const k=Math.floor(u%3600/60),w=u%60;return`${k>=10?k:`0${k}`}:${w>=10?w:`0${w}`}`}}),t.jsx(ge,{type:"button",onClick:f,children:a?t.jsx(be,{}):t.jsx(ve,{})}),t.jsxs(Ce,{children:["Burned calories: ",t.jsx(ze,{children:d.calories})]})]}),t.jsxs(je,{children:[t.jsx(Le,{children:z.map(({title:u,value:k},w)=>t.jsxs(Se,{children:[t.jsx(We,{children:u}),t.jsx(Ue,{children:k})]},w))}),t.jsx(he,{onSubmit:g,isPause:a,children:"Add to Diary"})]})]})},Fe=o.div`
  display: flex;
  flex-direction: column;
  justify-content: center;
  align-items: center;
