import{u as M,r as m,v as pr,R as $t,w as hr,b as xt,f as Ce,x as mr,j as x,y as Bt,z as ge,Q as vr,A as gr,L as br,C as xr,D as Er,E as Cr}from"./index-58ae4a8e.js";import{S as yr}from"./Section-83a60943.js";import{T as Sr}from"./Text.styled-0b0fd7f2.js";import{s as ye}from"./sprite-fc9ff37f.js";import{F as wr}from"./Form-7ed61629.js";import"./Fieldset.styled-f9438df6.js";/* empty css                         */import{_ as Ee,a as xn,b as Fr,c as Or,d as Ar,e as Dr,f as Ir,g as Mr}from"./defineProperty-8501a314.js";import{f as Pr}from"./format-4e6081aa.js";import{B as jt}from"./BasicModalWindow-57d9d33c.js";import{T as Ht}from"./Text-920efb75.js";import"./InputValidation-704be027.js";const Vr="/leader-code-team-power-pulse/assets/products-1x-60ae029e.jpg",Rr="/leader-code-team-power-pulse/assets/products-2x-88f016c5.jpg",Nt="/leader-code-team-power-pulse/assets/products-tablet-2x-d8bdd0d5.jpg",zt="/leader-code-team-power-pulse/assets/products-mobil-2x-b29d44f2.jpg",Lr=M.div`
  display: flex;
...
`,bn=M.span`
  color: var(--orange-color);
`,vs=()=>x.jsxs(ms,{children:[x.jsxs(Ht,{children:[x.jsx(bn,{children:"Sorry, no results were found"})," for the product filters you selected. You may want to consider other search options to find the product you want. Our range is wide and you have the opportunity to find more options that suit your needs."]}),x.jsx(Ht,{children:x.jsx(bn,{children:"Try changing the search parameters."})})]}),gs=t=>t.profile.profile.blood,bs=()=>{const t=xt(),e=Ce(Nr),r=Ce(gs),i=Ce(En),{search:n,category:o,recomended:u}=i;return m.useEffect(()=>{t(Cr({search:n,category:o.value,recomended:u.value}))},[t,n,o,u]),x.jsx("div",{children:e.length===0?x.jsx(vs,{}):x.jsx(ps,{children:e.map(({_id:s,weight:a,calories:l,category:c,title:d,groupBloodNotAllowed:g})=>x.jsx(hs,{children:x.jsx(fs,{id:s,weight:a,calories:l,category:c,title:d,isRecomended:!g[r]})},s))})})},xs=M.div`
  margin-top: 40px;
  margin-bottom: 40px;
...
`,Vs=()=>x.jsxs(yr,{backgrounds:{desctop:Vr,desctopretina:Rr,tablet:Nt,tabletretina:Nt,mobil:zt,mobilretina:zt},children:[x.jsx(xs,{children:x.jsx(Sr,{tag:"h1",size:"h3",children:"Products"})}),x.jsx(Vu,{}),x.jsx(bs,{})]});export{Vs as default};
