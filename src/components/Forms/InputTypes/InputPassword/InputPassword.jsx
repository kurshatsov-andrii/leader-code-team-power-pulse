...
const InputPassword = ({ type = 'password', name, label, value, placeholder, min, icon = 'password', max, required, onChange }) => {
  ...
  return (
    <Label>
      ...
      <InputWrapper>
        <Input type={customType} name={name} value={value} required={required} placeholder={placeholder} min={min} max={max} onChange={onChange} />
