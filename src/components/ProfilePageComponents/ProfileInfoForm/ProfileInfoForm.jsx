...
const ProfileInfoForm = () => {
  const [userData] = useState(useSelector(selectUserData));
  ...
  return (
    <Form onSubmit={handleSubmit}>
      <Fieldset col="2" colTablet="2" colMobil="1">
        <Input type="text" name="name" label="Name" value={userData.name} placeholder="Name" required />
        <Input type="email" name="email" label="Email" value={userData.email} placeholder="E-mail" disabled />
      </Fieldset>
      <Fieldset col="4" colTablet="4" colMobil="2">
        ...
        <Input type="date" name="birthday" label="Date of birth" value="11.12.1985" required icon="calendar" />
      </Fieldset>
      ...
      <Fieldset label="Activity level" col="1" colTablet="1" colMobil="1">
        <Input type="radio" name="levelActivity" label="Sedentary lifestyle (little or no physical activity)" value="1" required />
        <Input type="radio" name="levelActivity" label="Light activity (light exercises/sports 1-3 days per week)" value="2" required />
        <Input type="radio" name="levelActivity" label="Moderately active (moderate exercises/sports 3-5 days per week)" value="3" required />
        <Input type="radio" name="levelActivity" label="Very active (intense exercises/sports 6-7 days per week)" value="4" required />
        <Input type="radio" name="levelActivity" label="Extremely active (very strenuous exercises/sports and physical work)" value="5" required />
      </Fieldset>
      <ButtonsList>
